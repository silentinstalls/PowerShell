...
$apiUrl = "https://api.github.com/repos/microsoft/winget-pkgs/contents/manifests/v/voidtools/Everything"
...
Write-Host "Everything version: $latestVersion"
...
$webClient.DownloadFile($installerUrl, "$env:TEMP\Everything.msi")

# Start the install process.
Set-Location -Path $env:TEMP
Start-Process -FilePath msiexec.exe -ArgumentList '/i Everything.msi /qn' -Wait

# Delete the downloaded installer file.
Remove-Item -Path "$env:TEMP\Everything.msi" -Force -ErrorAction SilentlyContinue

Write-Host "Everything installation completed."
