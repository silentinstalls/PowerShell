...
Write-Host "Latest Brave Browser version: $latestVersion"
...
Remove-Item -Path "$env:TEMP\Brave-latest.exe" -Force -ErrorAction SilentlyContinue

Write-Host "Brave Browser installation completed."
