...
$apiUrl = "https://api.github.com/repos/microsoft/winget-pkgs/contents/manifests/a/Anysphere/Cursor"
...
Start-Process -FilePath "$env:TEMP\WinMerge-latest.exe" -ArgumentList '/VERYSILENT /NORESTART' -Wait
