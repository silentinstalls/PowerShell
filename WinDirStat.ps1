...
$apiUrl = "https://api.github.com/repos/microsoft/winget-pkgs/contents/manifests/w/WinDirStat/WinDirStat"
...
Write-Host "Latest WinDirStat version: $latestVersion."
...
$webClient.DownloadFile($installerUrl, "$env:TEMP\WinDirStat-latest.msi")

# Start the install process.
Set-Location -Path $env:TEMP
Start-Process -FilePath msiexec.exe -ArgumentList '/i WinDirStat-latest.msi /qn' -Wait

# Delete the downloaded installer file.
Remove-Item -Path "$env:TEMP\WinDirStat-latest.msi" -Force -ErrorAction SilentlyContinue
