...
$apiUrl = "https://api.github.com/repos/microsoft/winget-pkgs/contents/manifests/c/ChristianKindahl/InfraRecorder"
...
Write-Host "Latest InfraRecorder version: $latestVersion."
...
Invoke-WebRequest -UserAgent "Wget" -Uri $installerUrl -OutFile "$env:TEMP\InfraRecorder-latest.msi" 

# Start the install process.
Set-Location -Path $env:TEMP
Start-Process -FilePath msiexec.exe -ArgumentList '/i InfraRecorder-latest.msi /qn' -Wait

# Delete the downloaded installer file.
Remove-Item -Path "$env:TEMP\InfraRecorder-latest.msi" -Force -ErrorAction SilentlyContinue

Write-Host "InfraRecorder installation completed."
