...
$apiUrl = "https://api.github.com/repos/microsoft/winget-pkgs/contents/manifests/i/Inkscape/Inkscape"
...
Write-Host "Latest Inkscape version: $latestVersion."
...
$webClient.DownloadFile($installerUrl, "$env:TEMP\Inkscape-latest.msi")

# Start the install process.
Set-Location -Path $env:TEMP
Start-Process -FilePath msiexec.exe -ArgumentList '/i Inkscape-latest.msi /qn' -Wait

# Delete the downloaded installer file.
Remove-Item -Path "$env:TEMP\Inkscape-latest.msi" -Force -ErrorAction SilentlyContinue

Write-Host "Inkscape installation completed."
