...
$apiUrl = "https://api.github.com/repos/microsoft/winget-pkgs/contents/manifests/p/PeterPawlowski/foobar2000"
...
Write-Host "foobar2000 version: $latestVersion."
...
$webClient.DownloadFile($installerUrl, "$env:TEMP\foobar2000-latest.exe")

# Start the install process.
Start-Process -FilePath "$env:TEMP\foobar2000-latest.exe" -ArgumentList '/S' -Wait

# Delete the downloaded installer file.
Remove-Item -Path "$env:TEMP\foobar2000-latest.exe" -Force -ErrorAction SilentlyContinue

Write-Host "foobar2000 installation completed."
