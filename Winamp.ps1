...
$apiUrl = "https://api.github.com/repos/microsoft/winget-pkgs/contents/manifests/w/Winamp/Winamp"
...
Write-Host "Winamp version: $latestVersion."
...
$webClient.DownloadFile($installerUrl, "$env:TEMP\Winamp-latest.exe")

# Start the install process.
Start-Process -FilePath "$env:TEMP\Winamp-latest.exe" -ArgumentList '/S' -Wait

# Delete the downloaded installer file.
Remove-Item -Path "$env:TEMP\Winamp-latest.exe" -Force -ErrorAction SilentlyContinue

Write-Host "Winamp installation completed."
