...
$apiUrl = "https://api.github.com/repos/microsoft/winget-pkgs/contents/manifests/a/alfaview/alfaview"
...
Start-Process -FilePath msiexec.exe -ArgumentList "/i `"$env:TEMP\alfaview-latest.msi`" /qn" -Wait
