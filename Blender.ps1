...
$apiUrl = "https://api.github.com/repos/microsoft/winget-pkgs/contents/manifests/b/BlenderFoundation/Blender"
...
Write-Host "Latest Blender version: $latestVersion."
...
$webClient.DownloadFile($installerUrl, "$env:TEMP\Blender-latest.msi")

# Start the install process.
Set-Location -Path $env:TEMP
Start-Process -FilePath msiexec.exe -ArgumentList '/i Blender-latest.msi /qn' -Wait

# Delete the downloaded installer file.
Remove-Item -Path "$env:TEMP\Blender-latest.msi" -Force -ErrorAction SilentlyContinue

Write-Host "Blender installation completed."
