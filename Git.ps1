...
$apiUrl = "https://api.github.com/repos/microsoft/winget-pkgs/contents/manifests/g/Git/Git"
...
$webClient.DownloadFile($installerUrl, "$env:TEMP\Git-latest.exe")

# Start the install process.
Start-Process -FilePath "$env:TEMP\Git-latest.exe" -ArgumentList '/SP- /VERYSILENT /SUPPRESSMSGBOXES /NORESTART' -Wait

# Delete the downloaded installer file.
Remove-Item -Path "$env:TEMP\Git-latest.exe" -Force -ErrorAction SilentlyContinue
