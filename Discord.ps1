...
$apiUrl = "https://api.github.com/repos/microsoft/winget-pkgs/contents/manifests/d/Discord/Discord"
...
Write-Host "Discord version: $latestVersion."
...
$webClient.DownloadFile($installerUrl, "$env:TEMP\Discord-latest.exe")

# Start the install process.
& "$env:TEMP\Discord-latest.exe"

# Delete the downloaded installer file.
Remove-Item -Path "$env:TEMP\Discord-latest.exe" -Force -ErrorAction SilentlyContinue
