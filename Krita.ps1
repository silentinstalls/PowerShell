...
$apiUrl = "https://api.github.com/repos/microsoft/winget-pkgs/contents/manifests/k/KDE/Krita"
...
Write-Host "Latest Krita version: $latestVersion."
...
$webClient.DownloadFile($installerUrl, "$env:TEMP\Krita-latest.exe")

# Start the install process.
Start-Process -FilePath "$env:TEMP\Krita-latest.exe" -ArgumentList '/S' -Wait

# Delete the downloaded installer file.
Remove-Item -Path "$env:TEMP\Krita-latest.exe" -Force -ErrorAction SilentlyContinue

Write-Host "Krita installation completed."
