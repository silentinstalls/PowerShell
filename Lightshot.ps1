...
$apiUrl = "https://api.github.com/repos/microsoft/winget-pkgs/contents/manifests/s/Skillbrains/Lightshot"
...
Write-Host "Latest Lightshot version: $latestVersion"
...
$webClient.DownloadFile($installerUrl, "$env:TEMP\Lightshot-latest.exe")

# Start the install process.
& "$env:TEMP\Lightshot-latest.exe" /VERYSILENT /NORESTART

# Delete the downloaded installer file.
Remove-Item -Path "$env:TEMP\Lightshot-latest.exe" -Force -ErrorAction SilentlyContinue

Write-Host "Lightshot installation completed."
