...
$apiUrl = "https://api.github.com/repos/microsoft/winget-pkgs/contents/manifests/e/EpicGames/EpicGamesLauncher"
...
Write-Host "Latest Epic Games Launcher version: $latestVersion"
...
$webClient.DownloadFile($installerUrl, "$env:TEMP\EpicGamesLauncher-latest.msi")

# Start the install process.
Set-Location -Path $env:TEMP
Start-Process -FilePath msiexec.exe -ArgumentList '/i EpicGamesLauncher-latest.msi /qn' -Wait

# Delete the downloaded installer file.
Remove-Item -Path "$env:TEMP\EpicGamesLauncher-latest.msi" -Force -ErrorAction SilentlyContinue

Write-Host "Epic Games Launcher installation completed."
