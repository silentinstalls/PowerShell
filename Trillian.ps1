...
$apiUrl = "https://api.github.com/repos/microsoft/winget-pkgs/contents/manifests/c/CeruleanStudios/Trillian"
...
Write-Host "Trillian version: $latestVersion."
...
$webClient.DownloadFile($installerUrl, "$env:TEMP\Trillian-latest.msi")

# Start the install process.
Set-Location -Path $env:TEMP
Start-Process -FilePath msiexec.exe -ArgumentList '/i Trillian-latest.msi /qn' -Wait

# Delete the downloaded installer file.
Remove-Item -Path "$env:TEMP\Trillian-latest.msi" -Force -ErrorAction SilentlyContinue

Write-Host "Trillian installation completed."
