...
$apiUrl = "https://api.github.com/repos/microsoft/winget-pkgs/contents/manifests/v/Valve/Steam"
...
Write-Host "Latest Steam version: $latestVersion"
...
$webClient.DownloadFile($installerUrl, "$env:TEMP\Steam-latest.exe")

# Start the install process.
Start-Process -FilePath "$env:TEMP\Steam-latest.exe" -ArgumentList '/S' -Wait

# Delete the downloaded installer file.
Remove-Item -Path "$env:TEMP\Steam-latest.exe" -Force -ErrorAction SilentlyContinue

Write-Host "Steam installation completed."
