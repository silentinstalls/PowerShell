...
$apiUrl = "https://api.github.com/repos/microsoft/winget-pkgs/contents/manifests/a/AnyDesk/AnyDesk"
...
Write-Host "Latest Anydesk version: $latestVersion."
...
$webClient.DownloadFile($installerUrl, "$env:TEMP\Anydesk-latest.exe")

# Start the install process.
Start-Process -FilePath "$env:TEMP\Anydesk-latest.exe" -ArgumentList '--install --silent' -Wait

# Delete the downloaded installer file.
Remove-Item -Path "$env:TEMP\Anydesk-latest.exe" -Force -ErrorAction SilentlyContinue
